...
//    free(PC2_Filter_Coef_dTerm);
    ...
    //Setup of velocity controller 1:
     ...
     PID_pool[VC_CONTROLLER_1_ID].Kp = 1.42; //0.76282*2;
     PID_pool[VC_CONTROLLER_1_ID].Kd = 0.065; //0.0058;
     PID_pool[VC_CONTROLLER_1_ID].Ki = 7.8; //25.6063;
     ...
     float VC1_Filter_Coef_dTerm_A[MAX_NUMBER_OF_TABS] = {1.0,-0.98751192};
