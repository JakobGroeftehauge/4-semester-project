...
******************************************************************************/
{
   ...
   TempIntegral = integral + (error + pastError)*((PID_pool[id].Ti/PID_pool[id].Kp*PID_pool[id].dt)/2);

   output = PID_pool[id].Kp * error + TempIntegral + (PID_pool[id].Kp*PID_pool[id].Td*2)/PID_pool[id].dt * (pastError-error) - Ud;
   ...
   {
       output = PID_pool[id].Kp * error + (PID_pool[id].Kp*PID_pool[id].Td*2)/PID_pool[id].dt * (pastError-error) - Ud;
   ...
   Ud = (PID_pool[id].Td*PID_pool[id].Kp*2)/PID_pool[id].dt * (pastError-error) - Ud;
   pastError = error;
