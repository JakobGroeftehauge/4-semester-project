...
int main(void)
{
    ...
    // Create tasks
    // -------------------
    xTaskCreate(PID_PC_task, "Position controller 1", 200, &PC_1_parameter, 3, &PC_PID1_handle);
    xTaskCreate(PID_VC_task, "Velocity controller 1", 200, &VC_1_parameter, 2, &VC_PID1_handle);
