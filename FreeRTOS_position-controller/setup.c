...
******************************************************************************/
{
    PC_2_parameter.id = PC_CONTROLLER_1_ID;
    PC_2_parameter.slave_id = POS_1;
    PC_2_parameter.place_to_store_output = &control_1_vel_ref;
    PC_2_parameter.output_semaphore = &VEL_1_REF_SEM;
    PC_2_parameter.reference_signal = &control_1_pos_ref;
    PC_2_parameter.reference_semaphore = &POS_1_REF_SEM;
    PC_2_parameter.feedback_signal =  &control_1_pos;
    PC_2_parameter.feedback_semaphore =  &POS_1_SEM;
    PC_2_parameter.delayTime = 20;
    PC_2_parameter.queue_semaphore = &QUEUE_SEM;
    PC_2_parameter.output_id = 0;

    VC_2_parameter.id = VC_CONTROLLER_1_ID;
    VC_2_parameter.slave_id = VEL_1;
    VC_2_parameter.place_to_store_output = &control_1_vel_ref;
    VC_2_parameter.output_semaphore = &VEL_1_REF_SEM;
    VC_2_parameter.reference_signal = &control_1_vel_ref;
    VC_2_parameter.reference_semaphore = &VEL_1_REF_SEM;
    VC_2_parameter.feedback_signal = &control_1_vel;
    VC_2_parameter.feedback_semaphore = &VEL_1_SEM;
